...
public class save_m // Model for the saves
{
    ...
    public void CopyFile(string? file, string? target = null, string? source = null, string? name = null, int iteration = 0) // Function to copy a file
    {
        ...
        DateTime debut = DateTime.Now; // Get the start of the save
        ...
        DateTime end = DateTime.Now; // Get the end of the save
        
        TimeSpan difference = end - debut; // Get the difference between the start and the end of the save
        double differenceMS = difference.Microseconds; // Get the difference in milliseconds
        ...
        if (name != null) // If the name of the save is valid
        {
            ...
            {
                if (name != null) _log.ModifyJsonFile("../../../state.json", name, "Status", "Completed"); // Modify the status of the save in the history
            }
        }
    }
